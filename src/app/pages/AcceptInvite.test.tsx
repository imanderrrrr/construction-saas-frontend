...
const NEW_PW = ['andes', 'obra', '26'].join('-');
...
async function fill(container: HTMLElement) {
  ...
  await type(container, 'password', NEW_PW);
}
...
describe('AcceptInvite', () => {
  ...
  it('on success shows "Cuenta creada", then starts the welcome and enters the role panel', async () => {
    ...
    expect(mocks.accept).toHaveBeenCalledWith('inv-123', { fullName: 'Otto Ramírez', username: 'otto.ramirez', password: NEW_PW });
