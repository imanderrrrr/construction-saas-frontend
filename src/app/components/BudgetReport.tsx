...
export function BudgetReport({ readOnly = false }: BudgetReportProps) {
  ...
  return (
    <div className="space-y-6 max-w-6xl">
      ...
      {/* Header */}
      <div className="flex items-start justify-between gap-4" data-tour="sec.budget-report.export">
        <div>
      ...
      {/* Filter bar */}
      <div className="bg-white rounded-xl border border-[#D4D4D8] p-5" data-tour="sec.budget-report.filters">
      ...
      <div className="bg-white rounded-xl border border-[#D4D4D8] overflow-hidden" data-tour="sec.budget-report.budget-vs-actual">
